# Code adapted by Saeed Najafi (snajafi@ualberta.ca) to become an eagle version of llama.

import torch
from .configuration_llama import LlamaConfig
from torch import nn
from .modeling_llama import LlamaRMSNorm, LlamaDecoderLayer, LlamaRotaryEmbedding, LlamaPreTrainedModel, KwargsForCausalLM
...
class EagleLlamaModel(LlamaPreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`LlamaDecoderLayer`]
    We add a small down-projection in order to implement the eagle-version of it.
...
class EagleLlamaForCausalLM(LlamaPreTrainedModel, GenerationMixin):
